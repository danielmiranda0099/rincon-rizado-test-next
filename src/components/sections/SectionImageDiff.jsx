  ...
  return (
    <div className="section-contained-sm image-diff-container">
      <div className="image-diff-header">
        ...
        <p>
          Nuestra especialidad es el cuidado capilar y estética de los cabellos
          afro rizados, buscamos que te sientas orgullosa y segura de lucir tu
          ...
          <SwiperSlide className="swiper-item">
            <ImageDiff
              images={[
                ...
                "https://images.pexels.com/photos/2576788/pexels-photo-2576788.jpeg",
              ]}
            />
          </SwiperSlide>
          <SwiperSlide className="swiper-item">
            <ImageDiff
              images={[
                "images/Screenshot from 2023-10-13 16-26-27 (copy).png",
                "images/Screenshot from 2023-10-13 16-28-18 (copy).png",
              ]}
            />
          </SwiperSlide>
          <SwiperSlide className="swiper-item">
